...
<head>
    ...
    <title>Impresion Solicitud <?php echo e($solicitudCompra->id); ?></title>
    <style>
        :root {
            --bg: #f6f8fb;
            --panel: #ffffff;
...
<body>
    <div class="toolbar">
        <div class="title">N-de Control de la Solicitud: <?php echo e($codigoControlVisible); ?></div>
    ...
    <div class="canvas">
        <iframe id="pdfFrame" src="<?php echo e($pdfUrl); ?>" title="Vista previa PDF"></iframe>
    </div>
...
<?php /**PATH C:\laragon\www\SISTEMA-OFICIAL-AGARCORP\resources\views/solicitudes-compra/print-preview.blade.php ENDPATH**/ ?>