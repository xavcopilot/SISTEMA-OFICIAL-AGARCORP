...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title><?php echo e($title ?? 'Recepcion AGARCORP'); ?></title>
        ...
        <div class="kiosk-shell" style="margin-top: var(--k-screen-margin); margin-bottom: var(--k-screen-margin);">
            <div class="kiosk-topbar">
                <div class="kiosk-brand">
                    <img src="<?php echo e(asset('images/logo-agarcorp.png')); ?>" alt="AGARCORP">
                </div>
                ...
                <div class="kiosk-actions">
                    ...
                    <form method="POST" action="<?php echo e(route('recepcion.logout')); ?>">
                        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\SISTEMA-OFICIAL-AGARCORP\resources\views\layouts\recepcion.blade.php ENDPATH**/ ?>