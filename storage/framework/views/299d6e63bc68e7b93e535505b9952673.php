...
<head>
    ...
    <title>Impresion Sumario <?php echo e($sumario->correlativo_sdc ?? $sumario->id); ?></title>
    <style>
        :root {
            --bg: #f6f8fb;
            --panel: #ffffff;
...
<body>
    <div class="toolbar">
        <div class="title">Sumario: <?php echo e($sumario->correlativo_sdc ?? $sumario->id); ?></div>
    ...
    <div class="canvas">
        <iframe id="pdfFrame" src="<?php echo e($pdfUrl); ?>" title="Vista previa PDF Sumario"></iframe>
    </div>
...
<?php /**PATH C:\laragon\www\SISTEMA-OFICIAL-AGARCORP\resources\views\sumarios\print-preview.blade.php ENDPATH**/ ?>