...
<div x-data="{ open: false }" class="ag-module-help-wrap">
    ...
    >
        <div class="ag-module-help-head">
            <div>
                <div class="ag-module-help-title"><?php echo e($title); ?></div>
                <div class="ag-module-help-desc"><?php echo e($description); ?></div>
            </div>
            <button type="button" class="ag-module-help-close" @click="open = false">Cerrar</button>
        </div>

        <div class="ag-module-help-body">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($windows === []): ?>
                <div class="ag-module-help-empty">Este modulo no tiene ventanas adicionales configuradas.</div>
            <?php else: ?>
                <div class="ag-module-help-grid">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $windows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $window): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <article class="ag-module-help-card">
                            <h4><?php echo e((string) ($window['title'] ?? 'Ventana')); ?></h4>
                            <p><?php echo e((string) ($window['description'] ?? '')); ?></p>
                        </article>
...
<?php /**PATH C:\laragon\www\SISTEMA-OFICIAL-AGARCORP\resources\views\filament\module-help-chip.blade.php ENDPATH**/ ?>