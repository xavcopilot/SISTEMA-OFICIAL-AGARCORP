...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('pbi_movimientos_inventario', function (Blueprint $table) {
            $table->id();
            $table->foreignId('producto_id')->constrained('pbi_productos')->restrictOnDelete();
            $table->foreignId('orden_compra_id')->nullable()->constrained('pbi_ordenes_compra')->nullOnDelete();
            $table->foreignId('usuario_id')->nullable()->constrained('pbi_usuarios')->nullOnDelete();
    ...
    public function down(): void
    {
        ...
        Schema::dropIfExists('pbi_movimientos_inventario');
